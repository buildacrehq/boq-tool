...
const BOQ_TABLE = {
  ...
  parapet_msand:     { '20x30': 5000,  '20x40': 5000,  '30x40': 5000,  '30x50': 5000,  '40x40': 5000,  '40x60': 5000,  divisible: false },
  parapet_20mm:      { '20x30': 5000,  '20x40': 5000,  '30x40': 5000,  '30x50': 5000,  '40x40': 5000,  '40x60': 5000,  divisible: false },
...
export function calculateFullBOQ(project, prices, boqData = {}, vehicleData = {}) {
  ...
  const parapetMsand     = boqData['parapet_msand']?.[siteKey]  ?? BOQ_TABLE.parapet_msand[siteKey]
  const parapet20mm      = boqData['parapet_20mm']?.[siteKey]   ?? BOQ_TABLE.parapet_20mm[siteKey]
  if (useBlocks) {
  ...
  add('Parapet Wall', 'Parapet Wall — M Sand', 'Lumpsum', 1, parapetMsand, parapetMsand)
  add('Parapet Wall', 'Parapet Wall — 20mm Aggregate', 'Lumpsum', 1, parapet20mm, parapet20mm)
