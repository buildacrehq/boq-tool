...
export function calculateFullBOQ(project, prices, boqData = {}, vehicleData = {}) {
  ...
  // ============================================================
  const cwCost = Math.max(0, inputArea * 100 - 20000)
  add('Compound Wall', 'Compound Wall (4 sides)', 'Lumpsum', 1, project.has_compound_wall ? cwCost : 0, project.has_compound_wall ? cwCost : 0)

  // ============================================================
  // STAGE 20b — PARAPET WALL
  // ============================================================
  const parapetCost = Math.max(0, inputArea * 100 - 40000)
  add('Parapet Wall', 'Parapet Wall (Terrace)', 'Lumpsum', 1, parapetCost, parapetCost)
