...
export function calculateFullBOQ(project, prices, boqData = {}, vehicleData = {}) {
  ...
  add('Site Preparation', 'Site Cleaning', 'JCB+Tractor', 1, BOQ_TABLE.site_cleaning[siteLowerKey], BOQ_TABLE.site_cleaning[siteLowerKey])
  add('Site Preparation', 'Survey', 'Lumpsum', 1, BOQ_TABLE.survey[siteLowerKey], BOQ_TABLE.survey[siteLowerKey])
  add('Site Preparation', 'Soil Test', 'Lumpsum', 1, BOQ_TABLE.soil_test[siteLowerKey], BOQ_TABLE.soil_test[siteLowerKey])
  add('Site Preparation', 'Excavation', 'JCB+Tractor', 1, BOQ_TABLE.excavation[siteLowerKey], BOQ_TABLE.excavation[siteLowerKey])
  ...
  add('Footing', 'Anti Termite Treatment', 'Lumpsum', 1, BOQ_TABLE.anti_termite[siteLowerKey], BOQ_TABLE.anti_termite[siteLowerKey])
  add('Footing', 'Cover Blocks', 'Lumpsum', 1, BOQ_TABLE.cover_blocks[siteLowerKey], BOQ_TABLE.cover_blocks[siteLowerKey])
  ...
  // ============================================================
  add('Soil Refilling', 'Soil Refilling', 'Lumpsum', 1, BOQ_TABLE.soil_refilling[siteLowerKey], BOQ_TABLE.soil_refilling[siteLowerKey])
  ...
  // STAGE 21 — SERVICES
  // ============================================================
  const isLargeSite = BOQ_TABLE.site_cleaning[siteLowerKey] >= 20000
