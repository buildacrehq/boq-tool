...
export function calculateFullBOQ(project, prices, boqData = {}, vehicleData = {}) {
  ...
  if (project.has_ssm && project.ssm_courses) {
    ...
    const ssmSizestone = Math.round(boq('ssm_sizestone', inputArea) * courseMultiplier)
    ...
    const ssmCement = Math.round(boq('ssm_cement_2c', inputArea) * courseMultiplier)
    ...
    const ssmLabour = Math.round(boq('ssm_labour_2c', inputArea) * courseMultiplier)
