...
function getFloorPrefix(floorType, isGround) {
  if (isGround) {
    ...
    if (['1bhk', '1bhk_parking', '1bhk_2units'].includes(floorType)) return 'gf_1bhk'
    if (['2bhk', '2bhk_parking', '1bhk_2bhk'].includes(floorType)) return 'gf_2bhk'
    if (['3bhk', '2bhk_3bhk'].includes(floorType)) return 'gf_2bhk'
