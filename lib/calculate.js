...
export function calculateFullBOQ(project, prices, boqData = {}, vehicleData = {}) {
  ...
  // ============================================================
  const siteKey = getNearestUpperSize(inputArea)        // vehicles only — conservative
  const siteLowerKey = getNearestLowerSize(inputArea).key // all fixed-cost lookups
  ...
  floorsData.forEach((floor, index) => {
    ...
    const floorSizeKey = getNearestUpperSize(floorArea)   // for non-divisible items
    const floorLowerSize = getNearestLowerSize(floorArea) // for divisible scaling
