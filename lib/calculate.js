...
export function calculateFullBOQ(project, prices, boqData = {}, vehicleData = {}) {
  ...
  if (project.has_lift) {
    ...
    if (liftCost > 0) add('Steel', 'Lift — Shaft + Machine Room + Installation', 'Lumpsum', 1, liftCost, liftCost)
  }
  ...
  const totalUpsUnits = floorsData.reduce((sum, f) => {
