...
function getFloorPrefix(floorType, isGround) {
  if (isGround) {
    ...
    if (floorType === 'duplex_end_2mb') return 'uf_duplex2mb'
    if (floorType === 'duplex_end_study') return 'uf_duplexstudy'
    if (floorType === 'duplex_end') return 'uf_duplex2mb' // legacy fallback
